...
for l in  tomographs:
      ...
      #tilts = mdoc_info.get_tomolist(l)
      #tilts_dose = mdoc_info.dose_info(tilts, 1.58)
...
########## move the stacks
      ...
      shutil.move(f'{l[0:-9]}_motion_corr_nofilt.mrc', '../')
      shutil.move(f'{l[0:-9]}_motion_corr_dosefilt.mrc', '../')
